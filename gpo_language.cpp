/******************************************************************************
* Name:        gpo_language (GpFrame class)
...
#include "gpo_language.h"  // Unicode/html conversion array 
...
/************************************************************************
* Load Messages contained in GpOrbit_messages.txt and
* save them to private array Str0 
* iLang: 0=English 1=French 2=Italian 3=Spanish 4=German
*************************************************************************/
int GpFrame::LoadMenuMessages()
{
int status;
char fname[128];

strcpy(fname, "GpOrbit1_messages.txt");
